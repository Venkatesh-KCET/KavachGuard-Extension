! function(t, e) {
    ...
    var f = function() {
            function t(t, e) {
                this.node = this.createElement(t), e && this.set(e)
            }
            var e = t.prototype;
        ...
        g = function(t) {
            ...
            return p(e, t), e.prototype.applyAttr = function(e, i) {
        ...
        M = function(t) {
            function e(e) {
                ...
                (i = t.call(this) || this).config = arguments[0], i.canvas = s.canvas, i.map = s, i.shape = i.canvas.createPath({
                    d: n,
                    dataCode: a
                }, r), i.shape.addClass("jvm-region jvm-element");
            ...
            return p(e, t), e.prototype.updateLabelPosition = function() {
    ...
    var C = function(t) {
        function e(e) {
            ...
            return (i = t.call(this) || this)._map = h, i._isImage = !!a.initial.image, i.config = arguments[0], i.shape = h.canvas[i._isImage ? "createImage" : "createCircle"]({
                ...
                cx: r,
                cy: o
            }, i._getStyle(), l), i.shape.addClass("jvm-marker jvm-element"), i._isImage && i.updateLabelPosition(), n && i._createLabel(i.config), i
        }
        p(e, t);
        var i = e.prototype;
    ...
    var X = function() {
            ...
            return t.prototype.render = function() {
                var t, e, i, s, a = this._series.scale.getTicks(),
                    n = l("div", "jvm-legend-inner");
                ...
                for (var o = 0; o < a.length; o++) {
                    switch (t = l("div", "jvm-legend-tick"), e = l("div", "jvm-legend-tick-sample"), this._series.config.attribute) {
                        case "fill":
                            s = a[o].value, /\.(jpg|gif|png)$/.test(s) ? e.style.background = "url(" + a[o].value + ")" : e.style.background = a[o].value;
                            break;
                        case "stroke":
                            e.style.background = a[o].value;
                            break;
                        case "image":
                            e.style.background = "url(" + ("object" == typeof a[o].value ? a[o].value.url : a[o].value) + ") no-repeat center center", e.style.backgroundSize = "cover"
                    }
                    t.appendChild(e), i = a[o].label, this._options.labelRender && (i = this._options.labelRender(i));
                    var h = l("div", "jvm-legend-tick-text", i);
                    t.appendChild(h), n.appendChild(t)
                }
            }, t
        }(),
        E = function() {
        ...
        Y = function() {
            function t(t, e, i) {
                void 0 === t && (t = {}), this._map = i, this._elements = e, this._values = t.values || {}, this.config = t, this.config.attribute = t.attribute || "fill", t.attributes && this.setAttributes(t.attributes), "object" == typeof t.scale && (this.scale = new E(t.scale)), this.config.legend && (this.legend = new X(u({
                    map: this._map,
                    series: this
    ...
    var A = {
            handleContainerEvents: function() {
                ...
                this.params.draggable && (w.on(this.container, "mousemove", (function(n) {
                    if (!s) return !1;
                    a.transX -= (t - n.pageX) / a.scale, a.transY -= (e - n.pageY) / a.scale, a.applyTransform(), t = n.pageX, e = n.pageY, i.isBeingDragged = !0
                    ...
                    a.tooltip && a.tooltip.hide(), a.setScale(a.scale * o, n, r), t.preventDefault()
                }))
            },
            ...
            handleZoomButtons: function() {
                ...
                this.container.appendChild(i), this.container.appendChild(s), w.on(i, "click", (function() {
            ...
            bindContainerTouchEvents: function() {
                var t, e, i, s, a, n, r, o = this,
                    h = function(h) {
                        var l, c, u, p, d = h.touches;
                        if ("touchstart" == h.type && (r = 0), 1 == d.length) 1 == r && (u = o.transX, p = o.transY, o.transX -= (i - d[0].pageX) / o.scale, o.transY -= (s - d[0].pageY) / o.scale, o.tooltip.hide(), o.applyTransform(), u == o.transX && p == o.transY || h.preventDefault()), i = d[0].pageX, s = d[0].pageY;
                        else if (2 == d.length)
                            if (2 == r) c = Math.sqrt(Math.pow(d[0].pageX - d[1].pageX, 2) + Math.pow(d[0].pageY - d[1].pageY, 2)) / e, o.setScale(t * c, a, n), o.tooltip.hide(), h.preventDefault();
                            else {
            ...
            createLines: function(t, e, i) {
                ...
                for (var o in this.linesGroup = this.linesGroup || this.canvas.createGroup("jvm-lines-group"), t) {
                    ...
                    for (var l in e) {
                        ...
                        c.name === h.from && (n = this.getMarkerPosition(c)), c.name === h.to && (r = this.getMarkerPosition(c))
                    }!1 !== n && !1 !== r && (a = new _({
                        index: o,
                        map: this,
                        style: u({
            ...
            createMarkers: function(t, e) {
                ...
                for (var o in void 0 === t && (t = {}), void 0 === e && (e = !1), this.markersGroup = this.markersGroup || this.canvas.createGroup("jvm-markers-group"), this.markerLabelsGroup = this.markerLabelsGroup || this.canvas.createGroup("jvm-markers-labels-group"), t) {
                    if (i = t[o], a = this.getMarkerPosition(i), n = i.coords.join(":"), e) {
            ...
            createSeries: function() {
                for (var t in this.series = {
                    ...
                    for (var e = 0; e < this.params.series[t].length; e++) this.series[t][e] = new Y(this.params.series[t][e], this[t], this)
            },
            ...
            setScale: function(t, e, i, s, a) {
                var n, r, o, h, l, c, u, p, d, f, m = this,
                    g = 0,
                ...
                t > this.params.zoomMax * this.baseScale ? t = this.params.zoomMax * this.baseScale : t < this.params.zoomMin * this.baseScale && (t = this.params.zoomMin * this.baseScale), void 0 !== e && void 0 !== i && (n = t / this.scale, s ? (d = e + this.defaultWidth * (this.width / (this.defaultWidth * t)) / 2, f = i + this.defaultHeight * (this.height / (this.defaultHeight * t)) / 2) : (d = this.transX - (n - 1) / t * e, f = this.transY - (n - 1) / t * i)), a && v > 0 ? (o = this.scale, h = (t - o) / v, l = this.transX * this.scale, u = this.transY * this.scale, c = (d * t - l) / v, p = (f * t - u) / v, r = setInterval((function() {
                    g += 1, m.scale = o + h * g, m.transX = (l + c * g) / m.scale, m.transY = (u + p * g) / m.scale, m.applyTransform(), g == v && (clearInterval(r), m.emit("viewport:changed", [m.scale, m.transX, m.transY]))
            ...
            updateSize: function() {
                this.width = this.container.offsetWidth, this.height = this.container.offsetHeight, this.resize(), this.canvas.setSize(this.width, this.height), this.applyTransform()
            },
            coordsToPoint: function(t, e) {
                var i, s, a, n = D.maps[this.params.map].projection,
                    r = n.centralMeridian;
                return i = O[n.type](t, e, r), !!(s = this.getInsetForPoint(i.x, i.y)) && (a = s.bbox, i.x = (i.x - a[0].x) / (a[1].x - a[0].x) * s.width * this.scale, i.y = (i.y - a[0].y) / (a[1].y - a[0].y) * s.height * this.scale, {
        ...
        z = function() {
            function t(t) {
                ...
                return this._map = t, this._tooltip = document.body.appendChild(e), this._bindEventListeners(), this
            }
            var e = t.prototype;
            return e._bindEventListeners = function() {
                ...
                w.on(this._map.container, "mousemove", (function(e) {
                    if (t._tooltip.classList.contains("active")) {
                        var i, s, a = (i = t._map.container, s = "#jvm-regions-group", Element.prototype.querySelector.call(i, s)).getBoundingClientRect(),
                            ...
                            l = e.pageY - r - 5,
                            c = e.pageX - o - 5;
                        h && (l += r + 5, c -= 10), e.clientX < a.left + o + 5 && (c = e.pageX + 5 + 2, h && (c += 10)), t._tooltip.style.cssText = "top: " + l + "px; left: " + c + "px"
                    }
                }))
                ...
                if (!t) return this._tooltip.textContent;
        ...
        D = function() {
            ...
            return e.init = function(t) {
                ...
                if (Array.isArray(t)) return this.createMarkers(t, !0);
                ...
                this.legendHorizontal && (c(this.legendHorizontal), this.legendHorizontal = null), this.legendVertical && (c(this.legendVertical), this.legendVertical = null), this.scale = this.baseScale, this.transX = this.baseTransX, this.transY = this.baseTransY, this.applyTransform(), this.clearSelectedMarkers(), this.clearSelectedRegions(), this.removeMarkers()
            }, e.destroy = function(t) {
                var e = this;
                void 0 === t && (t = !0);
                var i = w.getEventRegistry(),
                    s = Object.keys;
                c(this.tooltip.getElement()), s(i).forEach((function(t) {
                    w.off(i[t].selector, t, i[t].handler)
                })), this.emit("map:destroyed"), t && s(this).forEach((function(t) {
                    try {
                        delete e[t]
                    } catch (t) {}
                }))
